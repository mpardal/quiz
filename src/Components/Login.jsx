...
const Login = () => {
  ...
  return (
    <main className="flex flex-col xl:flex-row items-center xl:justify-between h-full bg-gray-400">
      <div className="my-auto">
        <img src={stadium} alt="inscription" />
      </div>
      <form onSubmit={handleSubmit} className="flex flex-col m-auto gap-20 w-1/2">
        <h2 className="text-3xl text-center xl:text-left">CONNEXION</h2>
