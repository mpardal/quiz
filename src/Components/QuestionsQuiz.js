export const QuestionsQuiz = [
  {
    fournisseur: 'Mickael PARDAL (PM Dev)',
    sujet: 'Questions pour un Quiz sur le football',
    quizz: {
      debutant: [
        {
          id: 0,
        ...
        },
        {
          ...
          options: ['Bruce Wayne', 'Charles Xavier', 'Tony Stark', 'Henry Steven'],
          answer: 'Tony Stark',
          heroId: 1009368,
        },
        {
      ...
      confirme: [
        ...
        },
        {
          ...
          options: ['Un espion', 'Un physicien nucléaire', 'Un soldat', 'Un pilote'],
        ...
        },
        {
          ...
          options: ['Cascadeur', "Artiste d'effets spéciaux", 'Magicien', 'Sapeur pompier'],
      ...
      expert: [
        ...
        },
        {
          ...
          options: ['Carter Lombardo', 'Max Shrek', 'Reed Richards', 'Spider Company'],
